...
public:
    ...
    static constexpr uint16_t ADDR_ENABLE_PROT_A = 0x9024;   // Enable Protections A (COV, CUV, SCD, OCD, OCC)
    static constexpr uint16_t ADDR_ENABLE_PROT_B = 0x9025;   // Enable Protections B (OTC, OTD, UTC, UTD)
